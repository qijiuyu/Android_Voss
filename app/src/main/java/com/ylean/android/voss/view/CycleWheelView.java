package com.ylean.android.voss.view;
...
public class CycleWheelView extends ListView {
    ...
    @SuppressLint("NewApi") private void refreshItems() {
    ...
    @SuppressLint("NewApi") private void resetItems(int firstPosition, int position, int offset){
